    ...
    def __init__(self):
        super().__init__(
            ...
            system_prompt=(
                ...
                "1. You MUST ONLY use the information provided in the conversation history, especially from the 'tool' role. "
                "2. You MUST base your answer ONLY on the text provided in the 'tool' role. "
